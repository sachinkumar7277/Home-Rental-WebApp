...
class Profile(models.Model):
    ...
    premium_Validity = models.CharField(max_length=100,null=True,blank = True,default = "No Plan Active")
    PremiumDaysLeft = models.CharField(max_length=50,null=True,blank = True,default='0 Days Left')
