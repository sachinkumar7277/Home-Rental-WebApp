...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'phone', 'username', 'is_admin', 'is_staff', 'date_of_join', 'date_of_birth')
...
class SubscribedPremiumPlanAdmin(ModelAdmin):
    list_display = ['id', 'profile', 'start_date', 'end_date']
